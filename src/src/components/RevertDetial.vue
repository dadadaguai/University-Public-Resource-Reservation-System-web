    ...
    <el-form ref="form" :model="form" label-width="100px">
        ...
        <el-form-item label="上传照片*：">
            <el-upload
                ...
                :limit="3"
                :multiple="true"
                accept=".jpg,.jpeg,.mp3,.mp4,.png,.gif,.bmp,.pdf,.JPG,.JPEG,.PBG,.GIF,.BMP,.PDF"
                :file-list="fileList"
    ...
    export default {
        ...
        methods:{
            ...
            submitUpload() {
                ...
                //     formData.append('picture', file.raw); //此处一定是append file.raw 上传文件只需维护fileList file.raw.name要加上 
                // })
